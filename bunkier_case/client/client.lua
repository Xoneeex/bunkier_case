...
exports('StartBunkierCase', StartBunkierCase)
...
RegisterCommand('bunkier_case', function()
    local success = exports['bunkier_case']:StartBunkierCase()
    if success then
